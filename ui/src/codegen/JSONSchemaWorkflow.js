...
export const WORKFLOW_SCHEMA = {
  ...
  "properties": {
    "name": {
      "$id": "#/properties/name",
      "default": "",
      "description": "Workflow Name - should be without spaces or special characters. Underscores are allowed.",
      "examples": [
        "first_sample_workflow"
      ],
      "maxLength": 100,
      "pattern": "^\\w+$",
      "title": "Workflow Name",
        ...
        "anyOf": [
          {
            ...
            "properties": {
              ...
              "taskReferenceName": {
                ...
                "description": "A unique task reference name for this task in the entire workflow",
                "default": "",
                "examples": [
                  "get_population_data"
                ]
