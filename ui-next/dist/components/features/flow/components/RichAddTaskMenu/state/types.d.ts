...
export declare enum RichAddMenuTabs {
    ALL_TAB = "ALL",
    SYSTEMS_TAB = "System",
...
export declare enum MainStates {
    INIT = "init",
    CLOSED = "closed",
    IDLE = "idle",
...
export declare enum RichAddTaskMenuEventTypes {
    TYPING = "TYPING",
...
export type RichAddTaskMenuEvents = TypingEvent | CloseMenuEvent | GotToEndEvent | SetHoveredItemEvent | SetSelectedTabEvent | ScrollToTopEvent | SetMenuTypeEvent | FetchIntegrationToolsEvent | RefetchIntegrationsEvent | UpdateIntegrationDrillDownEvent | SwitchToIntegrationsEvent;
