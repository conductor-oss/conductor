...
import { AuthHeaders, CommonTaskDef, Crumb, WorkflowExecutionStatus, WorkflowDef } from "types";
import { OperationContextData } from "../components/RichAddTaskMenu/state/types";
export declare enum FlowActionTypes {
...
export type FlowEvents = SelectNodeEvent | SelectEdgeEvent | SelectTaskWithTaskRefEvent | PerformOperationEvent | OpenEdgeMenuEvent | CloseEdgeMenuEvent | SetLayoutEvent | ToggleNodeMenuEvent | UpdateWfDefinitionEvent | ResetNodeSelectionEvent | ResetZoomPositionEvent | StoppedDraggingNodeEvent | StartDraggingNodeEvent | SetCenterPositionEvent | UpdateCollapseWorkflowListEvent | DoneInvokeEvent<any> | ToggleShowDescriptionEvent;
export declare enum FlowMachineStates {
    INIT = "init",
