...
import { Crumb, CommonTaskDef, TaskStatus, WorkflowDef, ExecutionTask } from "types";
...
export type SubWorkflowFunction = (name: string, version?: number) => Promise<Partial<WorkflowDef>>;
export {};
