 ...
 */
export type AgentRuntimeType = "a2a" | "conductor" | "bedrock" | "microsoft-foundry" | "openai-assistants";
/**
 ...
 * identity.
 */
export type ProviderAgentRuntimeType = Exclude<AgentRuntimeType, "a2a" | "conductor">;
...
export type AgentTaskInput = A2AAgentTaskInput | ConductorAgentTaskInput | ProviderAgentTaskInput;
