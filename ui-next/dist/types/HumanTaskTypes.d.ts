...
export declare enum AssignmentCompletionStrategy {
...
export declare enum HumanTaskState {
    IN_PROGRESS = "IN_PROGRESS",
    PENDING = "PENDING",
    ASSIGNED = "ASSIGNED",
    COMPLETED = "COMPLETED",
...
export type HumanExecutionTask = {
    ...
    input: HumanTaskInputParams & HumanTaskProcessContext & Record<string, unknown>;
    taskId: string;
    state: HumanTaskState;
    workflowId: string;
    workflowName: string;
