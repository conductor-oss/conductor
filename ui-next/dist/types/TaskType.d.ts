...
export declare enum GRPCMethodTypes {
    UNARY = "UNARY",
...
export declare enum JDBCType {
    SELECT = "SELECT",
    UPDATE = "UPDATE"
}
export declare enum QueryProcessorType {
    CONDUCTOR_API = "CONDUCTOR_API",
    METRICS = "METRICS",
    CONDUCTOR_EVENTS = "CONDUCTOR_EVENTS"
}
export declare enum GetSignedJWTAlgorithmType {
    RS256 = "RS256"
}
...
export declare const jdbcParameterKeys: Array<keyof JDBCInputParameters>;
