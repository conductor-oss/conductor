...
export declare const FIELD_TYPE_STRING = "string";
...
export declare const FIELD_TYPE_NULL = "null";
export type FieldType = typeof FIELD_TYPE_STRING | typeof FIELD_TYPE_NUMBER | typeof FIELD_TYPE_OBJECT | typeof FIELD_TYPE_BOOLEAN | typeof FIELD_TYPE_NULL;
...
export type NullifyValues<T> = {
    [K in keyof T]: T[K] extends object ? T[K] extends null | undefined ? null : NullifyValues<T[K]> | null : T[K] extends undefined ? undefined : T[K] | null;
};
