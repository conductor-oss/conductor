import { EventExecutionResult, GroupedEventItem } from "pages/eventMonitor/types";
...
export declare enum RefreshMachineStates {
    INIT = "INIT",
    RUNNING = "RUNNING",
    END_TIMER = "END_TIMER",
...
export declare enum RefreshMachineEventTypes {
    TICK = "TICK",
...
export type TimerEvents = TickEvent | UpdateDurationEvent | RefreshEvent | PersistEventNameAndDuration;
