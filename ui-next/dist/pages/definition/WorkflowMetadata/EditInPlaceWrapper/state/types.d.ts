...
export declare enum EditInPlaceEventTypes {
...
export type EditInPlaceMachineEvents = ToggleEditingEvent | ChangeValueEvent | DisableEditingEvent | ValueUpdatedEvent;
