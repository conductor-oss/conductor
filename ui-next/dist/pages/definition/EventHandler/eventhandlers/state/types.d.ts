...
export declare enum SaveEventHandlerMachineEventTypes {
    SAVE_EVT = "SAVE_EVT",
...
export declare enum SaveEventHandlerStates {
    IDLE = "idle",
    EDITOR = "editor",
    FORM = "form",
