...
export declare enum RunMachineStates {
    IDLE = "IDLE",
    CHECK_INPUT_PARAMS = "CHECK_INPUT_PARAMS",
    RUN_WORKFLOW = "RUN_WORKFLOW"
}
export declare enum RunMachineEventsTypes {
...
export type RunMachineEvents = UpdateInputParamsEvent | UpdateCorrelationIdEvent | UpdateTasksToDomainEvent | ClearFormEvent | RunWorkflowEvent | HandlePopoverMessageEvent | UpdateAllFieldsEvent | UpdateIdempotencyStrategyEvent | UpdateIdempotencyKeyEvent | UpdateIdempotencyValuesEvent | ChangeTabEvent;
export {};
