...
export declare enum SaveWorkflowMachineEventTypes {
...
export type SaveWorkflowEvents = ConfirmSaveEvent | CancelSaveEvent | EditEvent | EditDebounceEvent | DoneInvokeEvent<string> | ConfirmOverrideEvent;
