...
export declare enum ErrorInspectorEventTypes {
...
export type StoredValidationError = ServerValidationError & Partial<TaskHistory>;
...
export interface ErrorInspectorMachineContext extends SchemaValidationResponse, ReferenceProblems {
    currentWf?: Partial<WorkflowDef>;
