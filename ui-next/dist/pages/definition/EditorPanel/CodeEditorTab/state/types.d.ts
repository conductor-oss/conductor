...
import { ErrorInspectorMachineEvents, WorkflowWithNoErrorsEvent } from "pages/definition/errorInspector/state/types";
...
export declare enum CodeMachineEventTypes {
    EDIT_EVT = "EDIT_EVT",
...
export type CodeMachineEvents = EditEvent | DebounceEditEvent | WorkflowWithNoErrorsEvent | HighlightTextReferenceEvent | JumpToFirstErrorEvent | ForceWorkflowEvent;
