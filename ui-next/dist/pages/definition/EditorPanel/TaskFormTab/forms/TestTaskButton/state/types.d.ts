...
export declare enum TestTaskButtonTypes {
...
export declare enum TestTaskButtonMachineStates {
...
export type TestTaskButtonEvents = TestTaskEvent | SetTaskDomainEvent | UpdateTaskVariablesEvent | SetTaskJsonEvent;
