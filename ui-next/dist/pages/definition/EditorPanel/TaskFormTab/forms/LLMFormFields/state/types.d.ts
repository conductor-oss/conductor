...
export declare enum LLMFormFieldsMachineEventTypes {
...
export declare enum LLMFormFieldsMachineStates {
...
export type LLMFormFieldsEvents = FocusEvent | SelectPromptNameEvent | UpdateTaskEvent;
