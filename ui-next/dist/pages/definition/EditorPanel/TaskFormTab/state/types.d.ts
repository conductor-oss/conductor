...
export declare enum FormMachineActionTypes {
...
export type TaskFormEvents = UpdateTaskEvent | CheckForTaskErrorsEvent | SelectEdgeEvent | UpdateCrumbsEvent | ForceRefreshTaskEvent | UpdateCollapseWorkflowListEvent;
