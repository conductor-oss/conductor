...
export declare enum LocalCopyMachineEventTypes {
...
export type LocalCopyMachineEvents = UpdateAttribsEvent | UseLocalChangesEvent | WorkflowWithNoErrorsEvent | RemoveLocalCopyEvent | RemoveLocalCopyMessageEvent | CancelEvent | DoneInvokeEvent<string>;
