...
export declare enum TaskDefinitionFormEventType {
...
export type HandleChangeTaskFormEvent = {
    ...
    name: string;
    value: number | string | Record<string, string | number> | boolean | null | string[] | undefined;
};
...
export type TaskDefinitionFormMachineEvent = HandleChangeTaskFormEvent | SetEditingFormFieldEvent | StopFormMachineEvent | SyncDataToParentEvent | ToggleFormModeEvent | SetSaveConfirmationEvent | SetResetConfirmationEvent | SetDeleteConfirmationEvent | ExportTaskToJsonEvent | ConfirmResetEvent | ResetFormEvent;
