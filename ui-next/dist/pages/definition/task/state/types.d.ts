...
import { TaskDefinitionFormContext, TaskDefinitionFormMachineEvent } from "../form/state/types";
export declare enum TaskTimeoutPolicy {
    RETRY = "RETRY",
    TIME_OUT_WF = "TIME_OUT_WF",
    ALERT_ONLY = "ALERT_ONLY"
}
export declare const TaskTimeoutPolicyLabel: {
    [key: string]: string;
};
...
export declare const TaskRetryLogicLabel: {
    [key: string]: string;
};
...
export declare enum TaskDefinitionMachineState {
    INIT = "init",
    FORM = "form",
    EDITOR = "editor",
...
export interface TaskDefinitionMachineContext {
    ...
    lastSelectedTab?: TaskDefinitionMachineState.FORM | TaskDefinitionMachineState.EDITOR;
}
export declare enum TaskDefinitionMachineEventType {
...
export type TaskDefinitionMachineEvent = CancelConfirmSaveEvent | CloseDialogEvent | ConfirmDeleteTaskEvent | ConfirmGoToDefineNewTask | ConfirmResetTaskEvent | DebounceHandleChangeTaskDefinitionEvent | ExportTaskToJSONFileEvent | HandleChangeTaskDefinitionEvent | HandleDefineNewConfirmationEvent | HandleDefineNewTaskEvent | HandleDeleteTaskDefConfirmationEvent | HandleResetConfirmationEvent | HandleRunTestTaskEvent | NeedSyncDataFromFormMachineEvent | NewSaveCompleteEvent | SaveTaskDefinitionEvent | SetDeleteConfirmationOpenEvent | SetInputParametersEvent | SetResetConfirmationOpenEvent | SetSaveConfirmationOpenEvent | SetTaskDomainEvent | SyncDataFromFormMachine | ToggleBulkModeEvent | SetTaskDefinitionEvent | ToggleFormModeEvent;
