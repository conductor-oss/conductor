...
export declare enum TaskDefinitionDialogsMachineType {
...
export type TaskDefinitionDialogsMachineEvent = ConfirmDeleteTaskEvent | ConfirmGoToDefineNewTask | ConfirmResetTaskEvent | HandleDefineNewConfirmationEvent | HandleDeleteTaskDefConfirmationEvent | HandleResetConfirmationEvent | SetDefineNewTaskOpenEvent | SetDeleteConfirmationOpenEvent | SetResetConfirmationOpenEvent;
...
export interface TaskDefinitionDialogsFinalContext {
    event: HandleDefineNewConfirmationEvent | HandleDeleteTaskDefConfirmationEvent | HandleResetConfirmationEvent;
}
