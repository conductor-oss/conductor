...
import { ErrorInspectorMachineEvents, WorkflowWithNoErrorsEvent } from "../errorInspector/state";
import { UseLocalCopyChangesEvent } from "../ConfirmLocalCopyDialog/state";
import { AuthHeaders, Crumb, TaskDef, WorkflowDef, WorkflowMetadataI, User } from "types";
import { FlowEvents } from "components/features/flow/state";
import { CodeTextReference } from "../EditorPanel/CodeEditorTab/state";
import { SavedCancelledEvent, SavedSuccessfulEvent } from "../confirmSave/state";
...
export declare enum LeftPaneTabs {
    WORKFLOW_TAB = 0,
    TASK_TAB = 1,
    CODE_TAB = 2,
    RUN_TAB = 3,
...
export declare enum DefinitionMachineEventTypes {
...
export declare const DONT_SHOW_IMPORT_SUCCESSFUL_DIALOG_TUTORIAL_AGAIN = "dontShowImportSuccessfulDialogTutorialAgain:2";
...
export interface DefinitionMachineContext {
    ...
    initialSelectedTaskReferenceName?: string;
    workflowDefaultRunParam?: Record<string, unknown>;
    saveSourceEventType?: DefinitionMachineEventTypes;
