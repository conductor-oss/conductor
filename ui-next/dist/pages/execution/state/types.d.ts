...
import { FlowEvents, SelectNodeEvent } from "components/features/flow/state/types";
import { TaskDef, ExecutedData, TaskType, AuthHeaders, WorkflowDef, User, WorkflowExecution, DoWhileSelection, ExecutionTask } from "types";
import { StatusMap } from "./StatusMapTypes";
import { SetSelectedTaskEvent } from "../RightPanel/state/types";
export declare enum COUNT_DOWN_TYPE {
    INFINITE = -1
}
export declare enum CountdownEventTypes {
    TICK = "TICK",
    DISABLE = "DISABLE",
    ENABLE = "ENABLE",
...
export declare enum ExecutionActionTypes {
...
export declare enum ExecutionTabs {
...
export type UpdateDurationEvent = {
    type: ExecutionActionTypes.UPDATE_DURATION | CountdownEventTypes.UPDATE_DURATION;
    duration?: number;
    countdownType?: COUNT_DOWN_TYPE;
    isDisabled?: boolean;
};
export type CountdownEvents = TickEvent | DisableEvent | EnableEvent | ForceEndEvent | UpdateDurationEvent | {
    type: "";
};
