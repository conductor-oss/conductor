...
import { ExecutionTask, AuthHeaders, TaskLog, WorkflowExecution, DoWhileSelection } from "types";
import { StatusMap } from "pages/execution/state/StatusMapTypes";
export declare enum RightPanelStates {
    IDLE = "IDLE",
...
export declare enum RightPanelContextEventTypes {
...
export type RightPanelEvents = UpdateSelectedTaskStatus | CloseRightPanelEvent | UpdateTaskLogsEvent | DoneInvokeEvent<ExecutionTask> | ReRunWorkflowFromTaskEvent | ClearErrorMessageEvent | SetSelectedTaskEvent | SetUpdatedExecutionEvent | ChangeCurrentTabEvent | SetDoWhileIterationEvent;
