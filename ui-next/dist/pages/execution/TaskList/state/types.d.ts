...
export declare enum TaskListMachineEventTypes {
...
export type TaskListMachineEvents = DoneInvokeEvent<TaskListPageResponse> | SendSelectionToParentEvent | NextPageEvent | ChangeRowsPerPageEvent | StatusFilterChangeEvent;
