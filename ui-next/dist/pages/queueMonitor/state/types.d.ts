...
export declare enum RangeOptions {
    GT = "GT",
    LT = "LT"
}
...
export declare enum QueueMachineEventTypes {
...
export type QueueMonitorMachineEvents = FetchQueueEvent | SelectQueueEvent | RefreshEvent | UpdateQueueOptionEvent | UpdateWorkerOptionEvent | UpdateLastPollTimeOptionEvent | UpdateDurationEvent | DoneInvokeEvent<FetchResponse>;
