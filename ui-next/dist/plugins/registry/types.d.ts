 ...
 */
export type TaskMenuCategory = "ALL" | "System" | "Operators" | "Alerting" | "Workers" | "AI Tasks" | "Integrations";
/**
 ...
 */
export type SidebarMenuTarget = "executionsSubMenu" | "definitionsSubMenu" | "integrationsSubMenu" | "apiSubMenu" | "adminSubMenu" | "helpMenu" | "root";
/**
 ...
 */
export type SearchResultMapper = (data: any[], searchTerm: string) => SearchResultItem[];
/**
