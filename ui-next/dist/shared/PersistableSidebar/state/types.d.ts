...
export declare enum PersistableSidebarStates {
    INIT = "INIT",
    EXPANDED = "EXPANDED",
    COLLAPSED = "COLLAPSED"
}
export declare enum PersistableSidebarEventTypes {
...
export type PersistableSidebarEvent = ToggleBannerEventType | ToggleSearchModalEventType | CollapseSidebarEventType | ExpandSidebarEventType | AddMenuEventType | RemoveMenuEventType | AddMenusEventType;
