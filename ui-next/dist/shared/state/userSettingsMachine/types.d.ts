...
export declare enum UserSettingsStates {
    INIT = "init",
...
export declare enum UserSettingsEventTypes {
...
export type UserSettingsEvents = SetFirstWorkflowExecutedEvent | AddDismissedMessageEvent | SetDismissAllMessagesEvent;
