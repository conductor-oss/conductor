 ...
 */
export declare enum AuthProviderStates {
    UNLOGGED = "UNLOGGED",
 ...
 */
export declare enum AuthMachineEventTypes {
    LOGOUT = "LOGOUT",
...
export type AuthProviderMachineEvents = {
    ...
    type: AuthMachineEventTypes.SET_TOKEN;
    data: {
        token: string;
    };
} | {
    type: AuthMachineEventTypes.SET_PROVIDER_USER;
    user: unknown;
} | {
