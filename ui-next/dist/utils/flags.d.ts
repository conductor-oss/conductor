...
export declare const FEATURES: Readonly<{
    ...
    ENABLE_RERUN_FROM_FORK_AND_DOWHILE_TASKS: "ENABLE_RERUN_FROM_FORK_AND_DOWHILE_TASKS";
...
export declare const featureFlags: {
    isEnabled: (feature: string, defaultValue?: boolean) => boolean;
    getValue: (feature: string, defaultValue?: string) => any;
    getContextValue: (feature: string) => any;
};
