...
export default function BasicSearch({
  ...
  // Filter keys live in useAgentSearchFilters so they are declared once
  ...
  // The clause formats for the basic-only filters (agent name/id, correlation
  // ids, idempotency key, modified times) are mirrored in basicFilterQuery.ts,
  // which seeds the SQL box when the format toggle is switched on. Keep the
  // two in sync.
