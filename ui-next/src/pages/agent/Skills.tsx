...
const INTRO_CONTENT = `**Skills** are reusable SKILL.md packages registered with the Conductor Agents runtime. Package bytes and metadata are persisted through Conductor's configured backend.`;
