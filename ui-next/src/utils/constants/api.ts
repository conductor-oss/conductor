export const WEBHOOK_API_BASE_URL = "/metadata/webhook";
export const METADATA_MIGRATIONS_ENVIRONMENTS_API_BASE_URL =
  "/metadata-migrations/environments";
...
export const INTEGRATIONS_API_URL = {
  BASE: INTEGRATIONS_BASE,
  ALL: `${INTEGRATIONS_BASE}/all`,
  DEF: `${INTEGRATIONS_BASE}/def`,
  EVENT_STATS: `${INTEGRATIONS_BASE}/eventStats`,
  PROVIDER: `${INTEGRATIONS_BASE}/provider`,
};
