...
import io.orkes.conductor.dao.archive.JdbcSchedulerArchivalDAO;
...
public class SchedulerOssConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(SchedulerArchivalDAO.class)
    public SchedulerArchivalDAO schedulerArchivalDAO(
            DataSource dataSource, ObjectMapper objectMapper) {
        return new JdbcSchedulerArchivalDAO(dataSource, objectMapper);
    }
}
