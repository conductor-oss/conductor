...
measuring response times and error rates. Run simultaneously on two machines
...
Example (machine 2):
  python3 test-12-load-blast.py --url http://<other-host>:8080 --count 25 --target 1771600000
"""
