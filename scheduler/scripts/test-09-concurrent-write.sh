...
# Both machines POST the same schedule name at the same epoch second.
...
# Example (machine 1): ./test-09-concurrent-write.sh http://localhost:8080
# Example (machine 2): ./test-09-concurrent-write.sh http://<other-host>:8080
