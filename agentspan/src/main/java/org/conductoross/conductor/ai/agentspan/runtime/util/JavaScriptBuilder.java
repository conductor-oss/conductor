    ...
    public static String customGuardrailNormalizeScript() {
        return iife(
                "  var raw = $.worker_output;"
                        ...
                        + "    var passed = raw.passed !== undefined ? (raw.passed !== false && raw.passed !== 'false') : (existingOnFail == null || existingOnFail === 'pass');"
                        + "    var actualOnFail = passed ? (existingOnFail === 'pass' ? 'pass' : null) : escalate(existingOnFail || defaultOnFail, fixedOutput);"
