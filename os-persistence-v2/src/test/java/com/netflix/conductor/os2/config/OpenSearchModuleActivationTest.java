...
/**
 * Tests that verify the OpenSearch v2 module activates correctly based on
...
public class OpenSearchModuleActivationTest {
    ...
    public static class ModuleActivatesWithOpensearch2Type {
        ...
        public void testOpenSearchV2BeansAreCreated() {
            ...
            assertEquals("com.netflix.conductor.os2.config.OpenSearchProperties",
        ...
        public void testIndexDAOBeanIsCreated() {
            ...
            assertTrue("IndexDAO bean should exist when opensearch2 is configured",
            ...
            assertTrue("IndexDAO should be from os2 package",
