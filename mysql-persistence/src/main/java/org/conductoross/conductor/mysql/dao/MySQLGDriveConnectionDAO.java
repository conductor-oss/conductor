...
public class MySQLGDriveConnectionDAO extends MySQLBaseDAO implements GDriveConnectionDAO {
    ...
    private static final String UPSERT_CONNECTION =
            "INSERT INTO gdrive_connection (connection_id, account_name, oauth_token_json) "
                    ...
                    + "oauth_token_json = VALUES(oauth_token_json), updated_at = CURRENT_TIMESTAMP";
    ...
    public MySQLGDriveConnectionDAO(
