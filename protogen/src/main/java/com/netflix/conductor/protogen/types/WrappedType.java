...
public class WrappedType extends AbstractType {
    ...
    public static com.netflix.conductor.protogen.types.WrappedType wrap(GenericType realType) {
        ...
        return new com.netflix.conductor.protogen.types.WrappedType(realType, wrappedType);
    }
