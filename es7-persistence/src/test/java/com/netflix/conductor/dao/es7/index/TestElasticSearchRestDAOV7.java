...
public class TestElasticSearchRestDAOV7 {
    ...
    private static ElasticSearchRestDAOV7 indexDAO;
    ...
    private static void deleteAllIndices() throws IOException {
        ...
        Response beforeResponse = restClient.performRequest(new Request(HttpMethod.GET, "/_cat/indices"));
        ...
        while ((line = bufferedReader.readLine()) != null) {
            ...
            restClient.performRequest(new Request(HttpMethod.DELETE, endpoint));
        }
    }
