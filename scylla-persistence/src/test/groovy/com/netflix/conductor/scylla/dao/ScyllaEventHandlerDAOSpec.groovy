...
class ScyllaEventHandlerDAOSpec extends ScyllaSpec {

    @Subject
    ScyllaEventHandlerDAO eventHandlerDAO

    ScyllaExecutionDAO executionDAO

    def setup() {
        eventHandlerDAO = new ScyllaEventHandlerDAO(session, objectMapper, cassandraProperties, statements)
