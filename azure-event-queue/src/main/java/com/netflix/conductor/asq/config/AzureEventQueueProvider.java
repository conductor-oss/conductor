...
public class AzureEventQueueProvider implements EventQueueProvider {
    ...
    public AzureEventQueueProvider(
            QueueServiceClient client, AzureEventQueueProperties properties, Scheduler scheduler) {
        this.client = client;
    ...
    public ObservableQueue getQueue(String queueURI) {
        return queues.computeIfAbsent(
                ...
                q -> {
                    try {
                        return new AzureObservableQueue.Builder()
