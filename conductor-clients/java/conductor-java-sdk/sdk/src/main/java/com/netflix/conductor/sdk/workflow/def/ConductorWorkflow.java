...
public class ConductorWorkflow<T> {
    ...
    /**
     * Starts a dynamic workflow without creating a definition in metadata store.
     *
     * <p><br>
     * <b>Note</b>: Use this with caution - as this does not promote re-usability of the workflows
     *
     ...
     */
    public String startDynamic(T input) {
        return workflowExecutor.startWorkflow(this, input);
    }

    /**
     *  Starts the workflow using registered metadata definitions
     *
     * @see #registerWorkflow()
     * @param name
     * @param input
     ...
     * @return the workflow id
     */
    public String start(String name, Integer version, Object input) {
        return workflowExecutor.startWorkflow(name, version, input);
    }
