...
public class TestSerDerSearchResult {
    ...
    public void testSerializeDeserialize() throws Exception {
        ...
        String SERVER_JSON = JsonTemplateSerDeserResolverUtil.getJsonString("SearchResult");
        SearchResult<Object> searchResult = objectMapper.readValue(SERVER_JSON, SearchResult.class);

        // 2. Assert that the fields are all correctly populated
        assertNotNull(searchResult);
        assertEquals(searchResult.getTotalHits(), 123L);
