 ...
 *
 * <p>Mirrors {@link AgentStartRequest} for the {@code agentConfig} field so the same agent
 * definition users hand to {@code /start} can be reused here — they just add a {@code plan} field
 * with the same shape PAC's planner LLM would emit.
 */
@Data
@Builder
@NoArgsConstructor
