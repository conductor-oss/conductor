...
/**
 * Establishes per-request org context for downstream DAO calls.
 *
 * <p>OSS deployments use the default no-op implementation; multi-tenant deployments (e.g. Orkes
...
public interface WebhookOrgContextProvider {
    ...
    WebhookOrgContextProvider NOOP = webhookId -> {};
}
