...
/**
 * Execution metadata for capturing NEW operational metadata not already present in Task/TaskResult models.
 * Contains enhanced timing measurements and additional context for operational purposes.
 */
@ProtoMessage
public class ExecutionMetadata {
    ...
    public String toString() {
        return "ExecutionMetadata{" +
                ...
                ", pollNetworkLatency=" + pollNetworkLatency +
                ", updateNetworkLatency=" + updateNetworkLatency +
