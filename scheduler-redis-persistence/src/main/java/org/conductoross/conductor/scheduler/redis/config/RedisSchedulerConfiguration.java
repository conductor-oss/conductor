 ...
 *
 * <p>Active when {@code conductor.db.type} is one of {@code redis_standalone}, {@code
 * redis_cluster}, or {@code redis_sentinel} AND {@code conductor.scheduler.enabled=true}. Injects
 * the existing {@link JedisProxy} bean — no new Redis connection infrastructure.
 */
@AutoConfiguration
