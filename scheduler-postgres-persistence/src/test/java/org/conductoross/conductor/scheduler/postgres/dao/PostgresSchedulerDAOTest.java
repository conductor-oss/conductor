 ...
 *
 * <p>Uses Testcontainers via the {@code jdbc:tc:postgresql:...} URL — no external database
 * required.
 */
...
public class PostgresSchedulerDAOTest {
    ...
    public void cleanDb() throws Exception {
        try (Connection conn = dataSource.getConnection()) {
            conn.prepareStatement("TRUNCATE TABLE scheduler CASCADE").executeUpdate();
            conn.prepareStatement("TRUNCATE TABLE scheduler_execution CASCADE").executeUpdate();
            conn.prepareStatement("TRUNCATE TABLE workflow_scheduled_executions CASCADE")
                    .executeUpdate();
        }
    }
