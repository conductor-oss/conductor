 ...
 */
package com.netflix.conductor.redis.config.rediscluster;
...
import com.netflix.conductor.redis.jedis.RedisClusterJedisProvider;
...
public class RedisClusterConfiguration {
    ...
    public JedisCommands jedisCommands(HostSupplier hostSupplier, RedisProperties properties) {
        return new RedisClusterJedisProvider(hostSupplier, properties).get();
    }
