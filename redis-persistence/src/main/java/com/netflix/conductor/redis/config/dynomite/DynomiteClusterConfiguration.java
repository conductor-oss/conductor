...
import com.netflix.conductor.redis.jedis.DynomiteJedisProvider;
...
public class DynomiteClusterConfiguration {
    ...
    public JedisCommands jedisCommands(RedisProperties properties, HostSupplier hostSupplier,
        ...
        return new DynomiteJedisProvider(properties, hostSupplier, tokenMapSupplier).get();
    }
