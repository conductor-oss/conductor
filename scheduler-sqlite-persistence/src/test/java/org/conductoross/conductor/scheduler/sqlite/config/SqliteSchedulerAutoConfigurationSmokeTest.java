...
public class SqliteSchedulerAutoConfigurationSmokeTest
     ...
     * in-memory database, causing Flyway to migrate a different DB than the DAO queries). The
     * abstract baseRunner() does not set this, so override it here unconditionally.
     */
    @Override
