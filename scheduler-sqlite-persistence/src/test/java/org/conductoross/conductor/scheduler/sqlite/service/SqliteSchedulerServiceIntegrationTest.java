...
/**
 * Runs the full {@link AbstractSchedulerServiceIntegrationTest} suite against an in-memory SQLite
 * database — no Docker required.
 *
 * <p>SQLite uses a connection pool of 1 because in-memory databases are connection-scoped. The
 * concurrency test in the abstract class still passes: concurrent service calls serialize through
...
public class SqliteSchedulerServiceIntegrationTest
