...
public class ZookeeperLockTest {
    ...
    public void setUp() throws Exception {
       // zkServer = new TestingServer(2181);
        ...
        Mockito.when(mockConfig.getZkConnection()).thenReturn("100.66.206.37:2181");
        Mockito.when(mockConfig.enableWorkflowExecutionLock()).thenReturn(true);
        zkLock = new ZookeeperLock(mockConfig, "wfexecution");
        Mockito.when(mockProvider.get()).thenReturn(zkLock);
    }
