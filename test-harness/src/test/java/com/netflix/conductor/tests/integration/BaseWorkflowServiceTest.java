 ...
 * @author Viren
 */
@SuppressWarnings({"Convert2MethodRef", "Convert2Diamond", "UnstableApiUsage", "ArraysAsListWithZeroOrOneArgument",
        "IfCanBeSwitch", "CodeBlock2Expr", "OptionalGetWithoutIsPresent", "SimplifiableJUnitAssertion"})
public abstract class BaseWorkflowServiceTest {
    protected static final String COND_TASK_WF = "ConditionalTaskWF";
    protected static final String FORK_JOIN_NESTED_WF = "FanInOutNestedTest";
    protected static final String FORK_JOIN_WF = "FanInOutTest";
    protected static final String DYNAMIC_FORK_JOIN_WF = "DynamicFanInOutTest";
    protected static final String DYNAMIC_FORK_JOIN_WF_LEGACY = "DynamicFanInOutTestLegacy";
    protected static final int RETRY_COUNT = 1;
    protected static final String JUNIT_TEST_WF_NON_RESTARTABLE = "junit_test_wf_non_restartable";
    protected static final String WF_WITH_SUB_WF = "WorkflowWithSubWorkflow";
    ...
    protected static final String LINEAR_WORKFLOW_T1_T2_SW = "junit_test_wf_sw";
    protected static final String LONG_RUNNING = "longRunningWf";
    protected static final String TEST_WORKFLOW_NAME_3 = "junit_test_wf3";

    protected final Logger logger;
    protected static boolean registered = false;
    protected static List<TaskDef> taskDefs = Collections.emptyList();

    protected BaseWorkflowServiceTest(Logger logger) {
        this.logger = logger;
    }
    ...
    protected void createSubWorkflow() {
    ...
    protected void verify(String inputParam1, String wfid, String task1Op, boolean fail) {
        Task task = workflowExecutionService.poll("junit_task_2", "task2.junit.worker");
        assertNotNull(task);
        assertTrue(workflowExecutionService.ackTaskReceived(task.getTaskId()));
    ...
    protected void createWorkflowDefForDomain() {
    ...
    protected void createWFWithResponseTimeout() {
        TaskDef task = new TaskDef();
    ...
    protected String runWorkflowWithSubworkflow() {
        clearWorkflows();
        createWorkflowDefForDomain();
    ...
    protected String runAFailedForkJoinWF() throws Exception {
        try {
    ...
    protected void printTaskStatuses(String wfid, String message) {
        Workflow wf = workflowExecutionService.getExecutionStatus(wfid, true);
        assertNotNull(wf);
        printTaskStatuses(wf, message);
    }

    protected boolean printWFTaskDetails = false;

    protected void printTaskStatuses(Workflow wf, String message) {
