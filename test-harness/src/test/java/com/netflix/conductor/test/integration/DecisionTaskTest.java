...
class DecisionTaskTest extends AbstractSpecification {
    ...
    @Test
    @DisplayName("Test simple decision workflow")
    void testSimpleDecisionWorkflow() throws Exception {
        // given: workflow input with decision task
        Map<String, Object> input = new HashMap<>();
        input.put("param1", "p1");
        input.put("param2", "p2");
        input.put("case", "c");

        // when: a decision workflow is started
        String workflowInstanceId = startWorkflow(DECISION_WF, 1, "decision_workflow", input, null);
        ...
        assertEquals("DECISION", workflow.getTasks().get(0).getTaskType());
    ...
    @Test
    @DisplayName("Test a workflow that has a decision task that leads to a fork join")
    void testDecisionTaskLeadingToForkJoin() throws Exception {
        // given: workflow input with decision task
        Map<String, Object> input = new HashMap<>();
        input.put("param1", "p1");
        input.put("param2", "p2");
        ...
        String workflowInstanceId =
                startWorkflow(FORK_JOIN_DECISION_WF, 1, "decision_forkjoin", input, null);
    ...
    void testDefaultCaseConditionExecutionOfConditionalWorkflow() throws Exception {
        ...
        assertEquals("DECISION", workflow.getTasks().get(0).getTaskType());
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(0).getStatus());
        assertEquals(List.of("xxx"), workflow.getTasks().get(0).getOutputData().get("caseOutput"));
        ...
        assertEquals("integration_task_10", workflow.getTasks().get(1).getTaskType());
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(1).getStatus());
        assertEquals("DECISION", workflow.getTasks().get(2).getTaskType());
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(2).getStatus());
        assertEquals(List.of("null"), workflow.getTasks().get(2).getOutputData().get("caseOutput"));
    }
    ...
    void testNestedAndCaseValueConditionExecutionOfConditionalWorkflow(
            ...
            throws Exception {
        // given: input for a workflow to ensure that 'nested' and caseValue decision tree is
        // executed
        Map<String, Object> input = new HashMap<>();
        ...
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(0).getStatus());
        assertEquals(
                List.of("nested"), workflow.getTasks().get(0).getOutputData().get("caseOutput"));
        assertEquals("DECISION", workflow.getTasks().get(1).getTaskType());
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(1).getStatus());
        assertEquals(
                List.of(caseValue), workflow.getTasks().get(1).getOutputData().get("caseOutput"));
        ...
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(3).getStatus());
        assertEquals(List.of("null"), workflow.getTasks().get(3).getOutputData().get("caseOutput"));
    }
    ...
    void testThreeCaseConditionExecutionOfConditionalWorkflow() throws Exception {
        ...
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(0).getStatus());
        assertEquals(
                List.of("three"), workflow.getTasks().get(0).getOutputData().get("caseOutput"));
        ...
        assertEquals(Task.Status.COMPLETED, workflow.getTasks().get(2).getStatus());
        assertEquals(
                List.of("notify"), workflow.getTasks().get(2).getOutputData().get("caseOutput"));
