...
Regression coverage includes the actual OpenAI, Anthropic, and Gemini options conversions, tool-schema mismatches, and finish-reason preservation across live calls, recording, and playback.
