...
public class TargetWorkflowCollectorTest {
    ...
    public void targetWorkflowsAreExtractedFromExpressionWhenExpressionIsPresent() {
        ...
        assertThat(workflowCollector.getWorkflowsToCompleteWebhooks()).containsKey("sample_workflow_2");
        assertThat(workflowCollector.getWorkflowsToCompleteWebhooks()).containsKey("sample_workflow_3");
    }
    ...
    public void targetWorkflowsAreExtractedFromDirectlyFromFieldsWhenExpressionIsAbsent() {
        ...
        webhookConfig.setReceiverWorkflowNamesToVersions(Map.of("sample_workflow_2_from_webhook_config_field", 1, "sample_workflow_3_from_webhook_config_field", 1));

        workflowCollector.visit(webhookConfig);

        assertThat(workflowCollector.getWorkflowsToStart()).containsKey("sample_workflow_1_from_webhook_config_field");
        assertThat(workflowCollector.getWorkflowsToCompleteWebhooks()).containsKey("sample_workflow_2_from_webhook_config_field");
        assertThat(workflowCollector.getWorkflowsToCompleteWebhooks()).containsKey("sample_workflow_3_from_webhook_config_field");
    }

    @Test()
    public void targetWorkflowsAreExtractedPreferentiallyFromExpressionWhenBothExpressionAndFieldsArePresent() {
    ...
    public void shouldPopIdempotencyKeyAndStrategy() {
        ...
        Map<String, Object> workflowsToStart = new HashMap<>(Map.of("sample_workflow_1_from_webhook_config_field", 1, "idempotencyKey", "sample_idempotency_key", "idempotencyStrategy", "RETURN_EXISTING"));
        webhookConfig.setWorkflowsToStart(workflowsToStart);
        Map<String, Integer> workflowsToComplete = new HashMap<>(Map.of("sample_workflow_2_from_webhook_config_field", 1, "sample_workflow_3_from_webhook_config_field", 1));
        ...
        assertThat(workflowCollector.popIdempotencyKey(requestBody)).isEqualTo("sample_idempotency_key");
        assertThat(workflowCollector.popIdempotencyKey(requestBody)).isEqualTo(StringUtils.EMPTY);//default
    ...
    private Object targetWorkflows() {
        return Map.of(
                ...
                "receiverWorkflowNamesToVersions", Map.of("sample_workflow_2", 1, "sample_workflow_3", 1)
        );
    }
}