...
/**
 * Tests that verify the OpenSearch v3 module activates correctly based on
 * conductor.indexing.type configuration.
 */
public class OpenSearchModuleActivationTest {
    ...
    public static class ModuleActivatesWithOpensearch3Type {
        ...
        public void testOpenSearchV3BeansAreCreated() {
            ...
            assertEquals("com.netflix.conductor.os3.config.OpenSearchProperties",
        ...
        public void testIndexDAOBeanIsCreated() {
            ...
            assertTrue("IndexDAO bean should exist when opensearch3 is configured",
            ...
            assertTrue("IndexDAO should be from os3 package",
                    indexDAO.getClass().getName().contains("com.netflix.conductor.os3"));
        }
    }
    ...
    public static class ModuleActivatesWithDefaultIndexingEnabled {
        ...
        public void testModuleActivatesWhenIndexingEnabledNotExplicitlySet() {
            ...
            assertTrue("IndexDAO bean should exist with default indexing.enabled=true",
                    context.containsBean("indexDAO"));
