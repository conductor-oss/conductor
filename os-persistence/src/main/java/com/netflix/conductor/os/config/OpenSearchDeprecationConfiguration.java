 ...
 *
 * <p>This configuration activates when {@code conductor.indexing.type=opensearch} is used,
 * which is now deprecated in favor of version-specific types.
 *
 * <p>The generic OpenSearch module has been split into version-specific modules to support
 * both OpenSearch 2.x and 3.x with isolated dependencies. Users must now explicitly specify
