...
public class WorkflowClient extends ClientBase {
    ...
    private static GenericType<SearchResult<WorkflowSummary>> searchResultWfSummary = new GenericType<SearchResult<WorkflowSummary>>() {
    };
     ...
     * @param version      the version of the wokflow
    ...
    public SearchResult<WorkflowSummary> search(String query) {
        SearchResult<WorkflowSummary> result = getForEntity("workflow/search", new Object[]{"query", query}, searchResultWfSummary);
        return result;
    }

    /**
     * Search for workflows based on payload using pagination
     *
