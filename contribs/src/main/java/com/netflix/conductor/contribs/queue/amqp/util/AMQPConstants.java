...
public class AMQPConstants {
     ...
     * <p>
     * {@see <a href="https://www.rabbitmq.com/queues.html">RabbitMQ</a>}.
     */
    ...
    /**
     * default rabbitmq auto delete When set to true the queues will be deleted when the last consumer is cancelled
     * <p>
     * {@see <a href="https://www.rabbitmq.com/queues.html">RabbitMQ</a>}.
     */
    ...
    /**
     * default rabbitmq delivery mode This is a property of the message When set to 1 the will be non persistent and 2
     * will be persistent {@see
     * <a href="https://www.rabbitmq.com/releases/rabbitmq-java-client/v3.5.4/rabbitmq-java-client-javadoc-3.5.4/com/rabbitmq/client/MessageProperties.html>
     * Message Properties</a>}.
     */
    public static int DEFAULT_DELIVERY_MODE = 2;
    /**
     * default rabbitmq delivery mode This is a property of the channel limit to get the number of unacknowledged
     * messages. {@see <a href="https://www.rabbitmq.com/consumer-prefetch.html>Consumer Prefetch</a>}.
     */
    public static int DEFAULT_BATCH_SIZE = 1;
    /**
     * default rabbitmq delivery mode This is a property of the amqp implementation which sets teh polling time to drain
     * the in-memory queue.
     */
