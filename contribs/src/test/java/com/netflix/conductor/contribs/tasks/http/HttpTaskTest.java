...
public class HttpTaskTest {
    ...
    //
    //        final TypeReference<Map<String, Object>> mapOfObj = new TypeReference<Map<String,
    // Object>>() {
    //        };
    //        MockServerClient client = new MockServerClient(mockServer.getHost(),
    ...
    //        input.setUri("http://" + mockServer.getHost() + ":" + mockServer.getServerPort() +
    // "/post");
    ...
    //
    //        new DeciderService(parametersUtils, metadataDAO, externalPayloadStorageUtils,
    // systemTaskRegistry,
