...
public interface QueueDAO {
     ...
     * @param id                 message id
     * @param offsetTimeInSecond time in seconds, after which the message should be marked visible.  (for timed queues)
     * @return true if the element was added to the queue.  false otherwise indicating the element already exists in the
     * queue.
     */
     ...
     * until specified duration. By default, the message is removed and pushed backed with postponeDurationInSeconds to
