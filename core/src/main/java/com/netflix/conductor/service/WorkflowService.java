...
public interface WorkflowService {
     ...
     * @return instance of {@link SearchResult}
     */
    SearchResult<Workflow> searchWorkflowsV2(int start, @Max(value = 5_000, message = "Cannot return more than {value} workflows. Please use pagination.") int size,
                                                  String sort, String freeText, String query);
     ...
     * @return instance of {@link SearchResult}
     */
    SearchResult<Workflow> searchWorkflowsByTasksV2(int start, int size, List<String> sort, String freeText, String query);
