...
public abstract class ConductorException extends RuntimeException {
    ...
    protected ConductorException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
