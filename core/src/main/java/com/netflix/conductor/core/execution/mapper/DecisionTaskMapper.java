 ...
 * {@link Task} starting with Task of type {@link SystemTaskType#DECISION} which is marked as IN_PROGRESS, followed by
...
public class DecisionTaskMapper implements TaskMapper {
    ...
    /**
     * This method evaluates the case expression of a decision task and returns a string representation of the evaluated
     * result.
     *
