...
public class WhileTaskMapperTest {
    ...
    public void setup() {
        ...
        workflowTask.setType(TaskType.WHILE.name());
    ...
    public void getMappedTasks() {
        ...
        List<TaskModel> mappedTasks =
                new WhileTaskMapper(metadataDAO, parametersUtils).getMappedTasks(taskMapperContext);

        assertNotNull(mappedTasks);
        assertEquals(mappedTasks.size(), 1);
        assertEquals(TASK_TYPE_WHILE, mappedTasks.get(0).getTaskType());
