...
/** Runs the {@link SchemaDAO} contract against a real SQLite database file. */
...
public class SqliteSchemaDAOTest extends SchemaDAOTest {
    ...
    protected SchemaDAO reopenStore() {
        return new SqliteSchemaDAO(retryTemplate, objectMapper, reopenedDataSource());
    }
