---- Precise SQLite Equivalent Schema to Postgres Migration
--
---- Metadata Tables
...
--CREATE INDEX combo_queue_message ON queue_message (queue_name, priority DESC, popped, deliver_on, created_on);

-- SQLite Schema Equivalent to Postgres Migration
