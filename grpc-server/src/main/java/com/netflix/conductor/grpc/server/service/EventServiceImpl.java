...
public class EventServiceImpl extends EventServiceGrpc.EventServiceImplBase {
    ...
    @Override
    public void getQueues(EventServicePb.GetQueuesRequest req,
        StreamObserver<EventServicePb.GetQueuesResponse> response) {
        response.onNext(
    ...
    @Override
    public void getQueueSizes(EventServicePb.GetQueueSizesRequest req,
        StreamObserver<EventServicePb.GetQueueSizesResponse> response) {
        EventServicePb.GetQueueSizesResponse.Builder builder = EventServicePb.GetQueueSizesResponse.newBuilder();
        for (Map.Entry<String, Map<String, Long>> pair : ((Map<String, Map<String, Long>>) eventService
            .getEventQueues(true)).entrySet()) {
    ...
    @Override
    public void getQueueProviders(EventServicePb.GetQueueProvidersRequest req,
        StreamObserver<EventServicePb.GetQueueProvidersResponse> response) {
        response.onNext(
