...
| ------------------ | ------------------- | ------------------------------------------------- | -------------------- |
| startWorkflow | Map[String, Any] | A map that includes the requested workflow’s configuration, such as the name and version. Refer to the [Start Workflow API](../../../../devguide/api/startworkflow.md#request-body) for what to include in this parameter. | Required. |
