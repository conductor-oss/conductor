...
These endpoints are used by workers to poll for tasks and update their results. They are typically called by the [SDK](../../devguide/clientsdks/index.md), not manually.
