...
For using an existing framework agent, such as LangChain, use [framework agent quickstarts](framework-agents.md). You can also call LLMs and tools directly from workflow tasks using Conductor's [native AI tasks](../devguide/ai/llm-orchestration.md).
