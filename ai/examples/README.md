...
### Conductor agent (embedded runtime) examples
...
### Crabbox remote execution examples

Run trusted commands on remote Crabbox capacity via an MCP bridge or an external
`SIMPLE` worker. See `integrations/crabbox` and `docs/devguide/ai/crabbox-sandbox.md`.
