...
public class WorkflowResource {
    ...
    public Map<String, List<Workflow>> getWorkflows(@PathParam("name") String name,
                                                    @QueryParam("includeClosed") @DefaultValue("false") boolean includeClosed,
                                                    @QueryParam("includeTasks") @DefaultValue("false") boolean includeTasks, List<String> correlationIds) {
    ...
    public String rerun(@PathParam("workflowId") String workflowId, RerunWorkflowRequest request) {
    ...
    @Consumes(MediaType.WILDCARD)
    public void reset(@PathParam("workflowId") String workflowId) {
